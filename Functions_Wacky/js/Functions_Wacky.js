...
var d= prompt("please enter the length  of side d")//length in meters
 ...
 (area/2===a*b/2)? console.log("This is a square"):console.log("you figure out the shape")// the area of a square is 2 times the area of a triangle.this is a ternary that shows if the condition is either true or false.